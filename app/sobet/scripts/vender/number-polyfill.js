  ...
  (function($) {
    ...
    $.fn.inputNumber = function() {
      $(this).filter(function() {
        var $this;
        $this = $(this);
        return $this.is('input[type="text"].spinner') && !($this.parent().is("span") && $this.next().is("div.number-spin-btn-container") && $this.next().children().first().is("div.number-spin-btn-up") && $this.next().children().eq(1).is("div.number-spin-btn-down"));
      }).each(function() {
    ...
    numberPolyfill = function(elem) {
      ...
      var nowelHeight = (this.elem.outerHeight()-2);
      elemHeight = nowelHeight + 'px';

      var initStyle= {
        style: "position: relative; white-space: nowrap"
      };

      var initBtnStyle = "height: " + elemHeight;
      var halfPaddingTop = parseInt((nowelHeight-21)/2,10);

      
      
      if (nowelHeight>21) {
        initStyle= {
          style: "position: relative; white-space: nowrap;display: inline-block;"
        };
        initBtnStyle = "height: " + elemHeight+";top:1px;";
      }
      ...
      $fieldContainer = $('<span/>',initStyle);


      this.elem.wrap($fieldContainer);
      this.upBtn.insertAfter(this.elem);
      this.downBtn.insertAfter(this.elem);
      this.elem.on({
        focus: function(e) {
          _this.elem.on({
      ...
      this.elem.on({
        ...
        keyup:debouncer(numberPolyfill.elemChangeHandler,200)
      }, {
        p: this
      });
      ...
      this.elem.css("textAlign", 'center');
    ...
    numberPolyfill.elemKeypressHandler = function(evt) {
      ...
      if (evt.keyCode === 38) {
        ...
        if(p.elem.attr('float') === undefined || $(p.elem).val().indexOf('.') !== -1) {
          evt.preventDefault();
        }
      } else if (((_ref = evt.keyCode) !== 8 && _ref !== 9 && _ref !== 35 && _ref !== 36 && _ref !== 37 && _ref !== 39 && _ref !== 46) && ((_ref1 = evt.which) !== 45 && _ref1 !== 46 && _ref1 !== 48 && _ref1 !== 49 && _ref1 !== 50 && _ref1 !== 51 && _ref1 !== 52 && _ref1 !== 53 && _ref1 !== 54 && _ref1 !== 55 && _ref1 !== 56 && _ref1 !== 57 && _ref1 !== 96 && _ref1 !== 97 && _ref1 !== 98 && _ref1 !== 99 && _ref1 !== 100 && _ref1 !== 101 && _ref1 !== 102 && _ref1 !== 103 && _ref1 !== 104 && _ref1 !== 105)) {
        evt.preventDefault();
      }
    };
    ...
    numberPolyfill.elemBtnMousedownHandler = function(evt) {
      ...
      timeoutFunc = function(incFunc) {
        p[func]();
        p.timeoutID = window.setTimeout(timeoutFunc, 40);
      };
    ...
    numberPolyfill.prototype.attrMutationHandler = function(name, oldValue, newValue) {
      ...
      if (name === "class" || name === "style") {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          i = _ref[_i];
          if ((ei = this.elem.css(i)) !== this.upBtn.css(i)) {
            h[i] = ei;
          }
        }
    ...
    numberPolyfill.prototype.increment = function() {
      ...
      if (!(this.elem.is(":disabled") || this.elem.is("[readonly]"))) {
        ...
        if(numberPolyfill.isFloat(params['step'])) {
          newVal = parseFloat(newVal).toFixed(numberPolyfill.getPrecision(params['step']));
        }
    ...
    $(function() {
      $('input[type="text"].spinner').inputNumber();
    });
  })(jQuery);
