export default {
    ssc: {
        ...
        get dxds_hzdxds_q3hz() {
            return this['zh_hzdxds_q3hz'];
        },
        zh_hzdxds_z3hz: {
            name: '中三总和',
            mathConfig: { type: 'leijia', needMultiplyPos: false },
        ...
        get dxds_hzdxds_z3hz() {
            return this['zh_hzdxds_z3hz'];
        },
        zh_hzdxds_h3hz: {
            name: '后三总和',
            mathConfig: { type: 'leijia', needMultiplyPos: false },
        ...
        get dxds_hzdxds_h3hz() {
            return this['zh_hzdxds_h3hz'];
        },
        qw_ts_yffs: {
            name: '一帆风顺',
            mathConfig: { type: 'leijia', needMultiplyPos: false },
    ...
    pk10: {
        ...
        rx2_zx_fs: {
            name: '任二直选复式',
            mathConfig: { type: 'pk10rzxfs', r: 2 },
            plate: {
                type: 'click',
                pos: ['冠军', '第一名', '第二名', '第三名', '第四名', '第五名', '第六名', '第七名', '第八名', '第九名', '第十名'],
                num: [...Array(10)].map((v, i) => ('0' + String(i + 1)).slice(-2)),
                filter: ['全', '大', '小', '奇', '偶', '清'].reverse()
            }
        },
        rx2_zx_ds: {
            name: '任二直选单式',
            mathConfig: { type: 'leijia', r: 2, needMultiplyPos: true },
            posSelect: ['冠军', '第一名', '第二名', '第三名', '第四名', '第五名', '第六名', '第七名', '第八名', '第九名', '第十名'],
            plate: {
                type: 'input',
                numOfEach: 2,//没注要求的数字数量 如五星是每注选号有5个数字
            }
